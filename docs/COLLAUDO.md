...
| C-002 | 2026-07-04 | E1/E2 / B6 — eliminazione | media | Manca l'eliminazione fisica di fasi, transizioni, campi, menu (set/opzioni) e anagrafiche: si può solo disattivare | Poter eliminare (quando non in uso) fasi, transizioni, campi, menu, collaboratori, professionisti | Solo disattivazione | 2 | risolto | Sprint 2 |
