...
- **S1.3** CRUD campi generali e campi fase (tipo, obbligo, visibilità tabella/filtri/export, ordine). *AC:* campo fase non compare in Nuova pratica; campo generale sì.
